        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '60px 24px' }}>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '20px' }}>
              ...
              <span style={{ fontSize: '0.68rem', color: '#4A4640', letterSpacing: '0.1em' }}>or</span>
              <div style={{ flex: 1, height: '1px', background: '#1F1D1A' }} />
            </div>
            ...
            <p style={{ textAlign: 'center', fontSize: '0.72rem', color: '#4A4640', lineHeight: 1.6, marginTop: '24px' }}>
